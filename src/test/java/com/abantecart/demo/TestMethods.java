...
public class TestMethods extends BaseTest{
    ...
    protected void invalidUserAccountCreationNoFirstNameTest(RegisterPage registerPage){
        ...
        assertEquals("First Name must be between 1 and 32 characters!", registerPage.getInvalidInputErrorMessage(), "The valid input length error message isn't displayed.");
    }
